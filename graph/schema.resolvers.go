...
import (
	...
	"github.com/akashabbasi/gogql/database"
...
func (r *mutationResolver) CreateJobListing(
	ctx context.Context,
	input model.CreateJobListingInput,
) (*model.JobListing, error) {
	return db.CreateJobListing(), nil
}

// UpdateJobListing is the resolver for the updateJobListing field.
func (r *mutationResolver) UpdateJobListing(
	ctx context.Context,
	id string,
	input model.UpdateJobListingInput,
) (*model.JobListing, error) {
	return db.UpdateJobListing(input), nil
}
